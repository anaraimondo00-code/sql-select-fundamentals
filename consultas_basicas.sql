...
-- CREACIÓN DE TABLAS Y AÑADIR INFO
...
-- El SELECT sirve para ver todas las columnas de una tabla, sin tener que saber de antemano cómo se llama cada una. 
-- Sirve para chequear que los datos se cargaron bien.
-- No conviene usarlo sin un filtro ya que trae columnas que capaz no necesitás.
